...
from SingleAgent.agents import SingleRecommenderAgent
...
def _compact_profile_for_agent(profile: dict[str, Any] | None) -> dict[str, Any]:
    if not profile:
        return {}
...
class SingleAgentRealtimeRecommender:
    def __init__(self, settings: Settings, cot_mode: str = "off") -> None:
        ...
        self.agent = SingleRecommenderAgent(self.openai_service, cot_mode=cot_mode)
    ...
    def _build_enriched_context(
        ...
        return enriched, _compact_profile_for_agent(profile)
    ...
    def _recommend_impl(
        ...
        rerank_pool_k = max(self.settings.forecaster_top_k, top_k)
        ...
        recommendations = self._finalize_recommendations(
            ...
            rows=agent_output.recommendations,
            top_k=top_k,
        )
        ...
        return {
            ...
            "intermediate": {
                ...
                "planning": agent_output.planning,
            },
            "recommendations": recommendations,
            "summary": agent_output.final_summary,
        }
