...
class AggregatorAgent:
    def __init__(self, config: dict[str, Any]) -> None:
        ...
        self.diversity_penalty = clip01(safe_float(config.get("diversity_penalty", 0.04), 0.04))
    ...
    def run(
        ...
        for candidate in candidates:
            ...
            retrieval_part = self.retrieval_weight * retrieval_norm.get(bid, 0.5)
            ...
            for activation in router_decision.activated_agents:
                ...
                part = float(activation.weight) * float(conf) * float(score)
